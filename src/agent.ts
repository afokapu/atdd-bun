...
/** Write the ATDD skill for every agent and a managed pointer block in AGENTS.md and CLAUDE.md. Existing
 * files and an existing block are kept unless `replace`; the rest of each instruction file is never touched. */
